...
class AIService {
  ...
  /**
   * Procesa el resultado de gráficos
   * @param {Object} result - Resultado del servidor
  ...
  /**
   * Procesa el resultado de tendencias
   * @param {Object} result - Resultado del servidor
