...
const TextRenderer = ({ component, excelData }) => {
  ...
  return (
    <div className="text-renderer p-4">
      {content ? (
        <div
        ...
        <div className="text-gray-500 italic text-center py-8 border-2 border-dashed border-gray-300 rounded">
