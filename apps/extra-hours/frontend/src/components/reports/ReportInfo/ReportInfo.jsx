  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (extraHours.length > 0) {
        console.log("[DEBUG] ExtraHours recibidas:", extraHours);
        if (
          role === "manager" ||
          ...
          console.log("[DEBUG] Datos procesados para manager:", processedData);
          ...
          console.log(
            "[DEBUG] Datos procesados para otros roles:",
            processedData
          );
          setEmployeeData(processedData);
        }
      } else {
        console.log("[DEBUG] No se encontraron horas extra");
        setError(
  ...
  return (
    <div className="ReportInfo report-component">
      <div className="component-header">
        <h1 className="component-title">Consulta de Horas Extras</h1>
      </div>
      ...
      <div className="actions-bar">
        ...
        {employeeData.length > 0 && (
          <div className="approval-filter">
            <Space>
              <Text strong id="filter-status-label">
                Filtrar por estado:
              </Text>
              <Select
        ...
        >
          {filteredData.length > 0 && (
            <div className="extra-hours-info">
              <Title level={3} id="extra-hours-records-title">
