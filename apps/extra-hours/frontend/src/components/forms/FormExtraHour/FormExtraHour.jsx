...
export const FormExtraHour = () => {
  ...
  return (
    <div className="form-container form-component">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group-date-time">
          ...
          <div className="form-field">
            <label htmlFor="startTime" id="startTime-label">
          ...
          <div className="form-field">
            <label htmlFor="endTime" id="endTime-label">
              <ClockIcon size={16} className="field-icon" />
        ...
        <h2 className="section-title" id="detail-hours-title">
          Detalle de Horas
        </h2>
        ...
        <div className="observaciones-container">
          <label htmlFor="observations" id="observatios-label">
            Observaciones
          </label>
          <textarea
            id="observations"
