...
const ExtraHoursSettings = () => {
  ...
  useEffect(() => {
    if (config) {
      ...
      console.log("weeklyExtraHoursLimit:", config.weeklyExtraHoursLimit);
  ...
  if (!config) {
    return (
      <div className="config-extra-hours">
        <div className="settings-container">Loading configuration...</div>
      </div>
    );
  }

  return (
    <div className="config-extra-hours config-component">
            ...
            <div className="input-container">
              ...
              >
                <InputNumber
                  ...
                  placeholder="Ingrese el límite semanal"
                />
              </Form.Item>
            </div>
          </div>
